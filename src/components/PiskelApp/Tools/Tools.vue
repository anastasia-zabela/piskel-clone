<template>
  <section class="tools">
      <Tool
        v-bind:iconTool="tools.pen.icon"
        v-bind:nameTool="tools.pen.name"
        v-bind:shortcut="tools.pen.shortcut"
        v-bind:title="'Pen tool'"  />
      <Tool
        v-bind:iconTool="tools.paintBucket.icon"
